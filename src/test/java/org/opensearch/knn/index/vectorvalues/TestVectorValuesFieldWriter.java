...
//
//public class TestVectorValuesFieldWriter {
//
...
//    }
//
//    public static class PredefinedFloatVectorBinaryDocValues extends  {
...
//        return new KNNBinaryVectorValues(new KNNVectorValuesIterator.FieldWriterIteratorValues(new PreDefinedBinaryVectorValues(vectors)));
//    }
//
//    public static KNNVectorValues<float[]> createKNNFloatVectorValues(final List<float[]> vectors) {
//        return new KNNFloatVectorValues(
//                new KNNVectorValuesIterator.FieldWriterIteratorValues(new PreDefinedFloatVectorValues(vectors))
//        );
//    }
//}

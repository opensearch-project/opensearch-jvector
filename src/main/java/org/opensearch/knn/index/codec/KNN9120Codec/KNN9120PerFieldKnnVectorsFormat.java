    ...
    public KNN9120PerFieldKnnVectorsFormat(final Optional<MapperService> mapperService) {
        super(
            ...
            (knnEngine, knnVectorsFormatParams) -> {
                ...
                switch (knnEngine) {
                    case LUCENE:
                        // There is an assumption here that hamming space will only be used for binary vectors. This will need to be fixed
                        // if that
                    ...
                    case JVECTOR:
                        return new JVectorFormat(
                            ...
                            knnVectorsFormatParams.getVectorizationProviderWrapper()
                        );
                    default:

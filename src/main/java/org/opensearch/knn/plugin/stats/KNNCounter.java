...
public enum KNNCounter {
    ...
    KNN_QUANTIZATION_TRAINING_TIME("knn_indexing_quantization_training_time"), // The time in indexing/merges that is spent on training the quantization parameters

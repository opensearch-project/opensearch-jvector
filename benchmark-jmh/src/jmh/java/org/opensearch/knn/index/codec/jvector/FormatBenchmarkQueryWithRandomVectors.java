...
import static org.opensearch.knn.index.codec.jvector.BenchmarkCommon.LUCENE104;
...
public class FormatBenchmarkQueryWithRandomVectors {
    ...
    @Param({ JVECTOR_NOT_QUANTIZED, JVECTOR_QUANTIZED, LUCENE104 })  // This will run the benchmark each codec type
